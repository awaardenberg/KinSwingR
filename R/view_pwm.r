...
viewPWM <- function(pwm_in = NULL, 
  ...
  # inverse log (some wobble from roundings and + 0.01 pseudo)
  pwm <- exp(which_pwm)/20
...
add.letter <- function(letter, x.position, y.position, prob, window.size){
